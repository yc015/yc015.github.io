!function(e, t) {
    ...
    n.m = i = [function(e, t, n) {
        ...
        e.exports = {
            init: function(e) {
                ...
                return !0 === (t = y.disable) || "mobile" === t && d.default.mobile() || "phone" === t && d.default.phone() || "tablet" === t && d.default.tablet() || "function" == typeof t && !0 === t() || n ? void v.forEach(function(e, t) {
                    e.node.removeAttribute("data-aos"),
                    e.node.removeAttribute("data-aos-easing"),
                    e.node.removeAttribute("data-aos-duration"),
                    e.node.removeAttribute("data-aos-delay")
                }) : (y.disableMutationObserver || u.default.isSupported() || (console.info('\n      aos: MutationObserver is not supported on this browser,\n      code mutations observing has been disabled.\n      You may have to call "refreshHard()" by yourself.\n    '),
                y.disableMutationObserver = !0),
                ...
                "DOMContentLoaded" === y.startEvent && -1 < ["complete", "interactive"].indexOf(document.readyState) ? r(!0) : "load" === y.startEvent ? window.addEventListener(y.startEvent, function() {
                    r(!0)
                }) : document.addEventListener(y.startEvent, function() {
                    r(!0)
                }),
                window.addEventListener("resize", (0,
                l.default)(r, y.debounceDelay, !0)),
                ...
                y.disableMutationObserver || u.default.ready("[data-aos]", o),
                v)
            },
            refresh: r,
            refreshHard: o
    ...
    , , , , , function(v, e) {
        (function(e) {
            ...
            function o(i, r, e) {
                ...
                function a(e) {
                    var t = e - h;
                    return void 0 === h || r <= t || t < 0 || y && d <= e - v
                }
                function s() {
                    var e, t, n = _();
                    return a(n) ? c(n) : void (p = setTimeout(s, (t = r - ((e = n) - h),
                    y ? k(t, d - (e - v)) : t)))
                }
                function c(e) {
                    return p = void 0,
                ...
                function t() {
                    ...
                    n) {
                        if (void 0 === p)
                            ...
                            m ? o(e) : f;
                        if (y)
                            return p = setTimeout(s, r),
                            o(h)
                    }
                    return void 0 === p && (p = setTimeout(s, r)),
                    f
                }
                var l, u, d, f, p, h, v = 0, m = !1, y = !1, n = !0;
                if ("function" != typeof i)
                    throw new TypeError(x);
                return r = b(r) || 0,
                g(e) && (m = !!e.leading,
                d = (y = "maxWait"in e) ? w(b(e.maxWait) || 0, r) : d,
            ...
            function b(e) {
                ...
                e = e.replace(s, "");
                var n = l.test(e);
                return n || u.test(e) ? d(e.slice(2), n ? 2 : 8) : c.test(e) ? r : +e
            }
    ...
    , function(e, t, n) {
        ...
        var i, r = n(13), a = (i = r) && i.__esModule ? i : {
            default: i
        };
        t.default = function(e, t) {
            ...
            return o.anchorPlacement || o.offset || isNaN(t) || (i = t),
            n + i
        }
    }
    , function(e, t) {
...
function(e, t) {
    ...
    : t(e)
}("undefined" != typeof window ? window : this, function(v, e) {
    "use strict";
    function m(e) {
    ...
    var d = "3.5.1 -ajax,-ajax/jsonp,-ajax/load,-ajax/script,-ajax/var/location,-ajax/var/nonce,-ajax/var/rquery,-ajax/xhr,-manipulation/_evalUrl,-deprecated/ajax-event-alias,-effects,-effects/Tween,-effects/animatedSelector"
      , A = function(e, t) {
    ...
    A.extend = A.fn.extend = function() {
        ...
        s--); s < c; s++)
            if (null != (e = arguments[s]))
                for (t in e)
                    i = e[t],
                    "__proto__" !== t && a !== i && (l && i && (A.isPlainObject(i) || (r = Array.isArray(i))) ? (n = a[t],
                    o = r && !Array.isArray(n) ? [] : r || A.isPlainObject(n) ? n : {},
                    r = !1,
                    a[t] = A.extend(l, o, i)) : void 0 !== i && (a[t] = i));
        return a
    }
    ,
    A.extend({
        ...
        isPlainObject: function(e) {
            var t, n;
            return !(!e || "[object Object]" !== o.call(e)) && (!(t = i(e)) || "function" == typeof (n = g.call(t, "constructor") && t.constructor) && a.call(n) === l)
        },
        ...
        makeArray: function(e, t) {
            var n = t || [];
            return null != e && (f(Object(e)) ? A.merge(n, "string" == typeof e ? [e] : e) : c.call(n, e)),
            n
        },
    ...
    var p = function(n) {
        ...
        var e, p, x, o, a, h, f, v, w, c, l, k, _, s, A, m, u, y, g, T = "sizzle" + +new Date, b = n.document, C = 0, i = 0, E = ce(), S = ce(), N = ce(), D = ce(), j = function(e, t) {
            return e === t && (l = !0),
            0
        }, L = {}.hasOwnProperty, t = [], q = t.pop, M = t.push, O = t.push, P = t.slice, z = function(e, t) {
            for (var n = 0, i = e.length; n < i; n++)
                if (e[n] === t)
                    return n;
            return -1
        }, I = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", R = "[\\x20\\t\\r\\n\\f]", F = "(?:\\\\[\\da-fA-F]{1,6}" + R + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", H = "\\[" + R + "*(" + F + ")(?:" + R + "*([*^$|!~]?=)" + R + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + F + "))|)" + R + "*\\]", B = ":(" + F + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + H + ")*)|.*)\\)|)", W = new RegExp(R + "+","g"), $ = new RegExp("^" + R + "+|((?:^|[^\\\\])(?:\\\\.)*)" + R + "+$","g"), U = new RegExp("^" + R + "*," + R + "*"), X = new RegExp("^" + R + "*([>+~]|" + R + ")" + R + "*"), J = new RegExp(R + "|>"), Y = new RegExp(B), V = new RegExp("^" + F + "$"), Q = {
            ID: new RegExp("^#(" + F + ")"),
            CLASS: new RegExp("^\\.(" + F + ")"),
            TAG: new RegExp("^(" + F + "|[*])"),
            ATTR: new RegExp("^" + H),
        ...
        }, G = /HTML$/i, K = /^(?:input|select|textarea|button)$/i, Z = /^h\d$/i, ee = /^[^{]+\{\s*\[native \w/, te = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ne = /[+~]/, ie = new RegExp("\\\\[\\da-fA-F]{1,6}" + R + "?|\\\\([^\\r\\n\\f])","g"), re = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g, oe = function(e, t) {
        ...
        try {
            O.apply(t = P.call(b.childNodes), b.childNodes),
        ...
        function se(t, e, n, i) {
            var r, o, a, s, c, l, u, d = e && e.ownerDocument, f = e ? e.nodeType : 9;
            if (n = n || [],
            ...
            A)) {
                    ...
                    if (r = c[1]) {
                        if (9 === f) {
                            ...
                            if (a.id === r)
                                return n.push(a),
                                n
                        } else if (d && (a = d.getElementById(r)) && g(e, a) && a.id === r)
                            return n.push(a),
                            n
                    } else {
                        if (c[2])
                ...
                if (p.qsa && !D[t + " "] && (!m || !m.test(t)) && (1 !== f || "object" !== e.nodeName.toLowerCase())) {
                    if (u = t,
                    d = e,
                    1 === f && (J.test(t) || X.test(t))) {
                        for ((d = ne.test(t) && ye(e.parentNode) || e) === e && p.scope || ((s = e.getAttribute("id")) ? s = s.replace(re, oe) : e.setAttribute("id", s = T)),
                        o = (l = h(t)).length; o--; )
        ...
        k = se.setDocument = function(e) {
            ...
            return i != _ && 9 === i.nodeType && i.documentElement && (s = (_ = i).documentElement,
            A = !a(_),
            b != _ && (n = _.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", r, !1) : n.attachEvent && n.attachEvent("onunload", r)),
            p.scope = ue(function(e) {
                return s.appendChild(e).appendChild(_.createElement("div")),
            ...
            p.getElementsByClassName = ee.test(_.getElementsByClassName),
            ...
            u = [],
            m = [],
            (p.qsa = ee.test(_.querySelectorAll)) && (ue(function(e) {
                var t;
                ...
                e.querySelectorAll("[selected]").length || m.push("\\[" + R + "*(?:value|" + I + ")"),
            ...
            (p.matchesSelector = ee.test(y = s.matches || s.webkitMatchesSelector || s.mozMatchesSelector || s.oMatchesSelector || s.msMatchesSelector)) && ue(function(e) {
                p.disconnectedMatch = y.call(e, "*"),
                y.call(e, "[s!='']:x"),
                u.push("!=", B)
            }),
            ...
            g = t || ee.test(s.contains) ? function(e, t) {
            ...
            j = t ? function(e, t) {
                ...
                return n || (1 & (n = (e.ownerDocument || e) == (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !p.sortDetached && t.compareDocumentPosition(e) === n ? e == _ || e.ownerDocument == b && g(b, e) ? -1 : t == _ || t.ownerDocument == b && g(b, t) ? 1 : c ? z(c, e) - z(c, t) : 0 : 4 & n ? -1 : 1)
            }
            : function(e, t) {
                if (e === t)
                    return l = !0,
                ...
                if (!r || !o)
                    return e == _ ? -1 : t == _ ? 1 : r ? -1 : o ? 1 : c ? z(c, e) - z(c, t) : 0;
                if (r === o)
                    return fe(e, t);
        ...
        se.matchesSelector = function(e, t) {
            if (k(e),
            p.matchesSelector && A && !D[t + " "] && (!u || !u.test(t)) && (!m || !m.test(t)))
                try {
                    var n = y.call(e, t);
        ...
        se.attr = function(e, t) {
            ...
            var n = x.attrHandle[t.toLowerCase()]
              , i = n && L.call(x.attrHandle, t.toLowerCase()) ? n(e, t, !A) : void 0;
            ...
            filter: {
                ...
                ATTR: function(n, i, r) {
                    return function(e) {
                        var t = se.attr(e, n);
                        return null == t ? "!=" === i : !i || (t += "",
                        "=" === i ? t === r : "!=" === i ? t !== r : "^=" === i ? r && 0 === t.indexOf(r) : "*=" === i ? r && -1 < t.indexOf(r) : "$=" === i ? r && t.slice(-r.length) === r : "~=" === i ? -1 < (" " + t.replace(W, " ") + " ").indexOf(r) : "|=" === i && (t === r || t.slice(0, r.length + 1) === r + "-"))
                    }
                },
                CHILD: function(h, e, t, v, m) {
                    ...
                    : function(e, t, n) {
                        var i, r, o, a, s, c, l = y != g ? "nextSibling" : "previousSibling", u = e.parentNode, d = b && e.nodeName.toLowerCase(), f = !n && !b, p = !1;
                        if (u) {
                            if (y) {
                                for (; l; ) {
                                    for (a = e; a = a[l]; )
                            ...
                            if (c = [g ? u.firstChild : u.lastChild],
                            g && f) {
                                for (p = (s = (i = (r = (o = (a = u)[T] || (a[T] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] || [])[0] === C && i[1]) && i[2],
                                a = s && u.childNodes[s]; a = ++s && a && a[l] || (p = s = 0) || c.pop(); )
                                    if (1 === a.nodeType && ++p && a === e) {
                                        r[h] = [C, s, p];
                                        break
                                    }
                            } else if (f && (p = s = (i = (r = (o = (a = e)[T] || (a[T] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] || [])[0] === C && i[1]),
                            !1 === p)
                                for (; (a = ++s && a && a[l] || (p = s = 0) || c.pop()) && ((b ? a.nodeName.toLowerCase() !== d : 1 !== a.nodeType) || !++p || (f && ((r = (o = a[T] || (a[T] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] = [C, p]),
                                a !== e)); )
                                    ;
            ...
            pseudos: {
                not: le(function(e) {
                    var i = []
                      , r = []
                      , s = f(e.replace($, "$1"));
                    return s[T] ? le(function(e, t, n, i) {
        ...
        function _e(p, h, v, m, y, e) {
            return m && !m[T] && (m = _e(m)),
            y && !y[T] && (y = _e(y, e)),
            le(function(e, t, n, i) {
                var r, o, a, s = [], c = [], l = t.length, u = e || function(e, t, n) {
                    for (var i = 0, r = t.length; i < r; i++)
                        se(e, t[i], n);
                    return n
                }(h || "*", n.nodeType ? [n] : n, []), d = !p || !e && h ? u : ke(u, s, p, n, i), f = v ? y || (e ? p : l || m) ? [] : t : d;
                if (v && v(d, f, n, i),
                m)
                    for (r = ke(f, c),
                    m(r, [], n, i),
                ...
                if (e) {
                    if (y || p) {
                        ...
                        for (o = f.length; o--; )
                            (a = f[o]) && -1 < (r = y ? z(e, a) : s[o]) && (e[r] = !(t[r] = a))
                    }
                } else
                    f = ke(f === t ? f.splice(l, f.length) : f),
                    y ? y(null, t, f, i) : O.apply(t, f)
            })
        }
        function Ae(e) {
            for (var r, t, n, i = e.length, o = x.relative[e[0].type], a = o || x.relative[" "], s = o ? 1 : 0, c = xe(function(e) {
                return e === r
            }, a, !0), l = xe(function(e) {
                return -1 < z(r, e)
            }, a, !0), u = [function(e, t, n) {
                var i = !o && (n || t !== w) || ((r = t).nodeType ? c : l)(e, t, n);
                return r = null,
                i
            }
            ]; s < i; s++)
                if (t = x.relative[e[s].type])
                    ...
                    if ((t = x.filter[e[s].type].apply(null, e[s].matches))[T]) {
                        for (n = ++s; n < i && !x.relative[e[n].type]; n++)
                            ;
                        return _e(1 < s && we(u), 1 < s && be(e.slice(0, s - 1).concat({
                            value: " " === e[s - 2].type ? "*" : ""
                        })).replace($, "$1"), t, s < n && Ae(e.slice(s, n)), n < i && Ae(e = e.slice(n)), n < i && be(e))
                    }
                    u.push(t)
                }
            return we(u)
        ...
        function Te(m, y) {
            function e(e, t, n, i, r) {
                var o, a, s, c = 0, l = "0", u = e && [], d = [], f = w, p = e || b && x.find.TAG("*", r), h = C += null == f ? 1 : Math.random() || .1, v = p.length;
                for (r && (w = t == _ || t || r); l !== v && null != (o = p[l]); l++) {
                    if (b && o) {
                        for (a = 0,
                ...
                g && l !== c) {
                    ...
                    if (e) {
                        if (0 < c)
                            for (; l--; )
                                u[l] || d[l] || (d[l] = q.call(i));
                        d = ke(d)
                    }
                    O.apply(i, d),
                    r && !e && 0 < d.length && 1 < c + y.length && se.uniqueSort(i)
                }
                return r && (C = h,
                w = f),
                u
        ...
        h = se.tokenize = function(e, t) {
            ...
            c = x.preFilter; a; ) {
                ...
                a = a.slice(n.length)),
                x.filter)
                    !(i = Q[o].exec(a)) || c[o] && !(i = c[o](i)) || (n = i.shift(),
                    r.push({
                        value: n,
                        type: o,
                        matches: i
        ...
        f = se.compile = function(e, t) {
            ...
            if (!o) {
                for (n = (t = t || h(e)).length; n--; )
                    (o = Ae(t[n]))[T] ? i.push(o) : r.push(o);
                (o = N(e, Te(r, i))).selector = e
            }
            return o
        }
        ,
        v = se.select = function(e, t, n, i) {
            var r, o, a, s, c, l = "function" == typeof e && e, u = !i && h(e = l.selector || e);
            if (n = n || [],
            1 === u.length) {
                if (2 < (o = u[0] = u[0].slice(0)).length && "ID" === (a = o[0]).type && 9 === t.nodeType && A && x.relative[o[1].type]) {
                    if (!(t = (x.find.ID(a.matches[0].replace(ie, d), t) || [])[0]))
                        return n;
                    l && (t = t.parentNode),
                    e = e.slice(o.shift().value.length)
                }
                for (r = Q.needsContext.test(e) ? 0 : o.length; r-- && (a = o[r],
                !x.relative[s = a.type]); )
                    if ((c = x.find[s]) && (i = c(a.matches[0].replace(ie, d), ne.test(o[0].type) && ye(t.parentNode) || t))) {
                        if (o.splice(r, 1),
                        !(e = i.length && be(o)))
                            return O.apply(n, i),
                            n;
            ...
            return (l || f(e, u))(i, t, !A, n, !t || ne.test(e) && ye(t.parentNode) || t),
            n
        }
        ,
    ...
    A.fn.extend({
        ...
        is: function(e) {
            return !!N(this, "string" == typeof e && C.test(e) ? A(e) : e || [], !1).length
        }
    });
    var D, j = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    (A.fn.init = function(e, t, n) {
        ...
        "string" != typeof e)
            ...
            this.length = 1,
            this) : x(e) ? void 0 !== n.ready ? n.ready(e) : e(A) : A.makeArray(e, this);
        if (!(i = "<" === e[0] && ">" === e[e.length - 1] && 3 <= e.length ? [null, e, null] : j.exec(e)) || !i[1] && t)
            return !t || t.jquery ? (t || n).find(e) : this.constructor(t).find(e);
        if (i[1]) {
            if (t = t instanceof A ? t[0] : t,
            A.merge(this, A.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : w, !0)),
            S.test(i[1]) && A.isPlainObject(t))
                for (i in t)
                    x(this[i]) ? this[i](t[i]) : this.attr(i, t[i]);
            return this
        }
    ...
    A.each({
        ...
        A.fn[i] = function(e, t) {
            ...
            t && "string" == typeof t && (n = A.filter(t, n)),
            1 < this.length && (q[i] || A.uniqueSort(n),
            L.test(i) && n.reverse()),
            this.pushStack(n)
        }
    });
        ...
        function r() {
            ...
            a = o = !0; l.length; u = -1)
                for (t = l.shift(); ++u < c.length; )
                    !1 === c[u].apply(t[0], t[1]) && i.stopOnFalse && (u = c.length,
                    t = !1);
            i.memory || (t = !1),
            o = !1,
            s && (c = t ? [] : "")
        }
        var o, t, a, s, c = [], l = [], u = -1, d = {
            add: function() {
                return c && (t && !o && (u = c.length - 1,
                l.push(t)),
                function n(e) {
                    A.each(e, function(e, t) {
                        x(t) ? i.unique && d.has(t) || c.push(t) : t && t.length && "string" !== _(t) && n(t)
                    })
                }(arguments),
                t && !o && r()),
                this
            ...
            has: function(e) {
                return e ? -1 < A.inArray(e, c) : 0 < c.length
            },
            empty: function() {
                return c = c && [],
                this
    ...
    A.extend({
              ...
              , a = {
                ...
                then: function(t, n, i) {
                        ...
                        return function() {
                            function e() {
                                ...
                                if (!(r < c)) {
                                    ...
                                    x(t) ? s ? t.call(e, l(c, o, P, s), l(c, o, z, s)) : (c++,
                                    t.call(e, l(c, o, P, s), l(c, o, z, s), l(c, o, P, o.notifyWith))) : (a !== P && (n = void 0,
                                    i = [e]),
                                    (s || o.resolveWith)(n, i))
                                }
                            }
                    ...
                    return A.Deferred(function(e) {
                        o[0][3].add(l(0, e, x(i) ? i : P, e.notifyWith)),
                        o[1][3].add(l(0, e, x(t) ? t : P)),
                        o[2][3].add(l(0, e, x(n) ? n : z))
                    }).promise()
                },
                promise: function(e) {
        ...
        when: function(e) {
            ...
            var n = arguments.length
              ...
              , o = s.call(arguments)
              , a = A.Deferred();
            if (n <= 1 && (I(e, a.done(t(i)).resolve, a.reject, !n),
    ...
    A.Deferred.exceptionHook = function(e, t) {
        v.console && v.console.warn && e && R.test(e.name) && v.console.warn("jQuery.Deferred exception: " + e.message, e.stack, t)
    }
    ,
    ...
    var F = A.Deferred();
    function H() {
        w.removeEventListener("DOMContentLoaded", H),
        v.removeEventListener("load", H),
        A.ready()
    }
    ...
    A.extend({
        ...
        readyWait: 1,
        ready: function(e) {
            (!0 === e ? --A.readyWait : A.isReady) || (A.isReady = !0) !== e && 0 < --A.readyWait || F.resolveWith(w, [A])
        }
    }),
    A.ready.then = F.then,
    "complete" === w.readyState || "loading" !== w.readyState && !w.documentElement.doScroll ? v.setTimeout(A.ready) : (w.addEventListener("DOMContentLoaded", H),
    ...
    A.fn.extend({
        data: function(n, e) {
            ...
            1 === o.nodeType && !V.get(o, "hasDataAttrs"))) {
                for (t = a.length; t--; )
                    a[t] && 0 === (i = a[t].name).indexOf("data-") && (i = X(i.slice(5)),
                    Z(o, i, r[i]));
    ...
    A.extend({
        queue: function(e, t, n) {
            ...
            if (e)
                return t = (t || "fx") + "queue",
                i = V.get(e, t),
                n && (!i || Array.isArray(n) ? i = V.access(e, t, A.makeArray(n)) : i.push(n)),
                i || []
        },
    ...
    A.fn.extend({
        queue: function(t, n) {
            ...
            t = "fx",
            e--),
            arguments.length < e ? A.queue(this[0], t) : void 0 === n ? this : this.each(function() {
                var e = A.queue(this, t, n);
                A._queueHooks(this, t),
                "fx" === t && "inprogress" !== e[0] && A.dequeue(this, t)
            })
        },
        dequeue: function(e) {
            return this.each(function() {
        ...
        promise: function(e, t) {
            ...
            var i, r = 1, o = A.Deferred(), a = this, s = this.length;
            for ("string" != typeof e && (t = e,
            e = void 0),
            e = e || "fx"; s--; )
                (i = V.get(a[s], e + "queueHooks")) && i.empty && (r++,
                i.empty.add(n));
            return n(),
            o.promise(t)
        }
    ...
    ie.getRootNode && (re = function(e) {
        return A.contains(e.ownerDocument, e) || e.getRootNode(oe) === e.ownerDocument
    }
    );
    function ae(e, t) {
        return "none" === (e = t || e).style.display || "" === e.style.display && re(e) && "none" === A.css(e, "display")
    }
    var se = {};
    function ce(e, t) {
        for (var n, i, r, o, a, s, c, l = [], u = 0, d = e.length; u < d; u++)
            (i = e[u]).style && (n = i.style.display,
            t ? ("none" === n && (l[u] = V.get(i, "display") || null,
            l[u] || (i.style.display = "")),
            "" === i.style.display && ae(i) && (l[u] = (c = a = o = void 0,
            a = (r = i).ownerDocument,
            s = r.nodeName,
            (c = se[s]) || (o = a.body.appendChild(a.createElement(s)),
            c = A.css(o, "display"),
            o.parentNode.removeChild(o),
            "none" === c && (c = "block"),
            se[s] = c)))) : "none" !== n && (l[u] = "none",
            V.set(i, "display", n)));
        for (u = 0; u < d; u++)
    ...
    var le, ue, de = /^(?:checkbox|radio)$/i, fe = /<([a-z][^\/\0>\x20\t\r\n\f]*)/i, pe = /^$|^module$|\/(?:java|ecma)script/i;
    le = w.createDocumentFragment().appendChild(w.createElement("div")),
    (ue = w.createElement("input")).setAttribute("type", "radio"),
    ue.setAttribute("checked", "checked"),
    ue.setAttribute("name", "t"),
    le.appendChild(ue),
    b.checkClone = le.cloneNode(!0).cloneNode(!0).lastChild.checked,
    le.innerHTML = "<textarea>x</textarea>",
    b.noCloneChecked = !!le.cloneNode(!0).lastChild.defaultValue,
    le.innerHTML = "<option></option>",
    b.option = !!le.lastChild;
    var he = {
        thead: [1, "<table>", "</table>"],
    ...
    function ve(e, t) {
        ...
        void 0 === t || t && E(e, t) ? A.merge([e], n) : n
    }
    function me(e, t) {
        for (var n = 0, i = e.length; n < i; n++)
    ...
    function ge(e, t, n, i, r) {
        for (var o, a, s, c, l, u, d = t.createDocumentFragment(), f = [], p = 0, h = e.length; p < h; p++)
            if ((o = e[p]) || 0 === o)
                if ("object" === _(o))
                    A.merge(f, o.nodeType ? [o] : o);
                else if (ye.test(o)) {
                    for (a = a || d.appendChild(t.createElement("div")),
                    s = (fe.exec(o) || ["", ""])[1].toLowerCase(),
                    c = he[s] || he._default,
                    a.innerHTML = c[1] + A.htmlPrefilter(o) + c[2],
                    u = c[0]; u--; )
                        a = a.lastChild;
        ...
        A.event.add(e, r, {
            ...
            handler: function(e) {
                ...
                if (1 & e.isTrigger && this[r]) {
                    if (i.length)
                        (A.event.special[r] || {}).delegateType && e.stopPropagation();
                    else if (i = s.call(arguments),
                    V.set(this, r, i),
                    t = o(this, r),
                    this[r](),
                    i !== (n = V.get(this, r)) || t ? V.set(this, r, !1) : n = {},
                    i !== n)
                        return e.stopImmediatePropagation(),
                        e.preventDefault(),
                        n.value
                } else
                    i.length && (V.set(this, r, {
                        value: A.event.trigger(A.extend(i[0], A.Event.prototype), i.slice(1), this)
                    }),
                    e.stopImmediatePropagation())
            }
        })) : void 0 === V.get(e, r) && A.event.add(e, r, ke)
    }
    A.event = {
        global: {},
        add: function(t, e, n, i, r) {
            var o, a, s, c, l, u, d, f, p, h, v, m = V.get(t);
            if (J(t))
                for (n.handler && (n = (o = n).handler,
                r = o.selector),
                r && A.find.matchesSelector(ie, r),
                ...
                l = (e = (e || "").match(O) || [""]).length; l--; )
                    ...
                    d.setup && !1 !== d.setup.call(t, i, h, a) || t.addEventListener && t.addEventListener(p, a)),
        ...
        remove: function(e, t, n, i, r) {
            var o, a, s, c, l, u, d, f, p, h, v, m = V.hasData(e) && V.get(e);
            if (m && (c = m.events)) {
                for (l = (t = (t || "").match(O) || [""]).length; l--; )
                    if (p = v = (s = we.exec(t[l]) || [])[1],
                    h = (s[2] || "").split(".").sort(),
                    p) {
                        ...
                        a && !f.length && (d.teardown && !1 !== d.teardown.call(e, h, m.handle) || A.removeEvent(e, p, m.handle),
                        delete c[p])
                    } else
                        for (p in c)
                            A.event.remove(e, p + t[l], n, i, !0);
                A.isEmptyObject(c) && V.remove(e, "handle events")
            }
        },
        dispatch: function(e) {
            var t, n, i, r, o, a, s = new Array(arguments.length), c = A.event.fix(e), l = (V.get(this, "events") || Object.create(null))[c.type] || [], u = A.event.special[c.type] || {};
            for (s[0] = c,
            t = 1; t < arguments.length; t++)
                s[t] = arguments[t];
            if (c.delegateTarget = this,
            !u.preDispatch || !1 !== u.preDispatch.call(this, c)) {
                for (a = A.event.handlers.call(this, c, l),
                t = 0; (r = a[t++]) && !c.isPropagationStopped(); )
                    ...
                    n = 0; (o = r.handlers[n++]) && !c.isImmediatePropagationStopped(); )
                        ...
                        c.data = o.data,
                        void 0 !== (i = ((A.event.special[o.origType] || {}).handle || o.handler).apply(r.elem, s)) && !1 === (c.result = i) && (c.preventDefault(),
                        c.stopPropagation()));
            ...
            if (c && l.nodeType && !("click" === e.type && 1 <= e.button))
                for (; l !== this; l = l.parentNode || this)
                    if (1 === l.nodeType && ("click" !== e.type || !0 !== l.disabled)) {
                        ...
                        a = {},
                        n = 0; n < c; n++)
                            void 0 === a[r = (i = t[n]).selector + " "] && (a[r] = i.needsContext ? -1 < A(r, this).index(l) : A.find(r, this, null, [l]).length),
                            a[r] && o.push(i);
                        o.length && s.push({
                            elem: l,
                            handlers: o
        ...
        special: {
            ...
            click: {
                setup: function(e) {
                    var t = this || e;
                    return de.test(t.type) && t.click && E(t, "input") && Ce(t, "click", ke),
                    !1
                },
                trigger: function(e) {
                    var t = this || e;
                    return de.test(t.type) && t.click && E(t, "input") && Ce(t, "click"),
                    !0
                },
                _default: function(e) {
                    var t = e.target;
    ...
    function Me(n, i, r, o) {
        i = y(i);
        var e, t, a, s, c, l, u = 0, d = n.length, f = d - 1, p = i[0], h = x(p);
        if (h || 1 < d && "string" == typeof p && !b.checkClone && Se.test(p))
            return n.each(function(e) {
                var t = n.eq(e);
                h && (i[0] = p.call(this, e, t.html())),
                Me(t, i, r, o)
            });
        if (d && (t = (e = ge(i, n[0].ownerDocument, !1, n, o)).firstChild,
        1 === e.childNodes.length && (e = t),
        t || o)) {
            for (s = (a = A.map(ve(e, "script"), je)).length; u < d; u++)
                c = e,
                u !== f && (c = A.clone(c, !0, !0),
                s && A.merge(a, ve(c, "script"))),
                r.call(n[u], c, u);
            if (s)
                ...
                u = 0; u < s; u++)
                    c = a[u],
                    pe.test(c.type || "") && !V.access(c, "globalEval") && A.contains(l, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? A._evalUrl && !c.noModule && A._evalUrl(c.src, {
                        nonce: c.nonce || c.getAttribute("nonce")
                    }, l) : k(c.textContent.replace(Ne, ""), c, l))
        }
        return n
    }
    function Oe(e, t, n) {
        for (var i, r = t ? A.filter(t, e) : e, o = 0; null != (i = r[o]); o++)
            n || 1 !== i.nodeType || A.cleanData(ve(i)),
            i.parentNode && (n && re(i) && me(ve(i, "script")),
    ...
    A.extend({
        ...
        clone: function(e, t, n) {
            var i, r, o, a, s, c, l, u = e.cloneNode(!0), d = re(e);
            if (!(b.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || A.isXMLDoc(e)))
                for (a = ve(u),
                i = 0,
                r = (o = ve(e)).length; i < r; i++)
                    s = o[i],
                    c = a[i],
                    "input" === (l = c.nodeName.toLowerCase()) && de.test(s.type) ? c.checked = s.checked : "input" !== l && "textarea" !== l || (c.defaultValue = s.defaultValue);
            if (t)
                if (n)
                    for (o = o || ve(e),
                    a = a || ve(u),
                    ...
                    qe(e, u);
            return 0 < (a = ve(u, "script")).length && me(a, !d && ve(e, "script")),
            u
        },
        cleanData: function(e) {
            for (var t, n, i, r = A.event.special, o = 0; void 0 !== (n = e[o]); o++)
                if (J(n)) {
                    if (t = n[V.expando]) {
                        if (t.events)
                            for (i in t.events)
                                r[i] ? A.event.remove(n, i) : A.removeEvent(n, i, t.handle);
                        n[V.expando] = void 0
                    }
    ...
    A.fn.extend({
        ...
        empty: function() {
            for (var e, t = 0; null != (e = this[t]); t++)
                1 === e.nodeType && (A.cleanData(ve(e, !1)),
                e.textContent = "");
            return this
        },
        clone: function(e, t) {
        ...
        html: function(e) {
            return B(this, function(e) {
                ...
                if (void 0 === e && 1 === t.nodeType)
                    return t.innerHTML;
                if ("string" == typeof e && !Ee.test(e) && !he[(fe.exec(e) || ["", ""])[1].toLowerCase()]) {
                    e = A.htmlPrefilter(e);
                    try {
                        for (; n < i; n++)
                            1 === (t = this[n] || {}).nodeType && (A.cleanData(ve(t, !1)),
                            t.innerHTML = e);
                        t = 0
                    } catch (e) {}
                }
        ...
        replaceWith: function() {
            ...
            return Me(this, arguments, function(e) {
                ...
                A.inArray(this, n) < 0 && (A.cleanData(ve(this)),
    ...
    A.each({
        ...
        A.fn[e] = function(e) {
            for (var t, n = [], i = A(e), r = i.length - 1, o = 0; o <= r; o++)
    ...
    var ze, Ie, Re, Fe, He, Be, We, $e, Ue = new RegExp("^(" + ee + ")(?!px)[a-z%]+$","i"), Xe = function(e) {
        var t = e.ownerDocument.defaultView;
        return t && t.opener || (t = v),
    ...
    function Ye() {
        if ($e) {
            ...
            ie.appendChild(We).appendChild($e);
            var e = v.getComputedStyle($e);
            ze = "1%" !== e.top,
    ...
    function Qe(e, t, n) {
        ...
        return (n = n || Xe(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || re(e) || (a = A.style(e, t)),
        !b.pixelBoxStyles() && Ue.test(a) && Je.test(t) && (i = s.width,
        r = s.minWidth,
        o = s.maxWidth,
    ...
    We = w.createElement("div"),
    ($e = w.createElement("div")).style && ($e.style.backgroundClip = "content-box",
    ...
    A.extend(b, {
        ...
        reliableTrDimensions: function() {
            var e, t, n, i;
            return null == He && (e = w.createElement("table"),
            ...
            i = v.getComputedStyle(t),
            He = 3 < parseInt(i.height),
            ie.removeChild(e)),
            He
        }
    }));
    ...
    var nt, it, rt = /^(none|table(?!-c[ea]).+)/, ot = /^--/, at = {
        position: "absolute",
        visibility: "hidden",
        display: "block"
    }, st = {
    ...
    function lt(e, t, n, i, r, o) {
        ...
        if (n === (i ? "border" : "content"))
            return 0;
        for (; a < 4; a += 2)
            "margin" === n && (c += A.css(e, n + ne[a], !0, r)),
            i ? ("content" === n && (c -= A.css(e, "padding" + ne[a], !0, r)),
            "margin" !== n && (c -= A.css(e, "border" + ne[a] + "Width", !0, r))) : (c += A.css(e, "padding" + ne[a], !0, r),
            "padding" !== n ? c += A.css(e, "border" + ne[a] + "Width", !0, r) : s += A.css(e, "border" + ne[a] + "Width", !0, r));
        return !i && 0 <= o && (c += Math.max(0, Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - o - c - s - .5)) || 0),
        c
    }
    function ut(e, t, n) {
        var i = Xe(e)
          , r = (!b.boxSizingReliable() || n) && "border-box" === A.css(e, "boxSizing", !1, i)
          , o = r
          , a = Qe(e, t, i)
        ...
        return (!b.boxSizingReliable() && r || !b.reliableTrDimensions() && E(e, "tr") || "auto" === a || !parseFloat(a) && "inline" === A.css(e, "display", !1, i)) && e.getClientRects().length && (r = "border-box" === A.css(e, "boxSizing", !1, i),
        (o = s in e) && (a = e[s])),
        (a = parseFloat(a) || 0) + lt(e, t, n || (r ? "border" : "content"), o, i, a) + "px"
    }
    A.extend({
        cssHooks: {
            opacity: {
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var r, o, a, s = X(t), c = ot.test(t), l = e.style;
                if (c || (t = tt(s)),
                ...
                "string" === (o = typeof n) && (r = te.exec(n)) && r[1] && (n = function(e, t, n, i) {
                    ...
                    , c = s(), l = n && n[3] || (A.cssNumber[t] ? "" : "px"), u = e.nodeType && (A.cssNumber[t] || "px" !== l && +c) && te.exec(A.css(e, t));
                    if (u && u[3] !== l) {
                        for (c /= 2,
                        l = l || u[3],
                        u = +c || 1; a--; )
                ...
                o = "number"),
                null != n && n == n && ("number" !== o || c || (n += r && r[3] || (A.cssNumber[s] ? "" : "px")),
        ...
        css: function(e, t, n, i) {
            var r, o, a, s = X(t);
            return ot.test(t) || (t = tt(s)),
            (a = A.cssHooks[t] || A.cssHooks[s]) && "get"in a && (r = a.get(e, !0, n)),
            void 0 === r && (r = Qe(e, t, i)),
    ...
    A.each(["height", "width"], function(e, c) {
        A.cssHooks[c] = {
            get: function(e, t, n) {
                if (t)
                    return !rt.test(A.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? ut(e, c, n) : Pe(e, at, function() {
                        return ut(e, c, n)
                    })
            },
            set: function(e, t, n) {
                var i, r = Xe(e), o = !b.scrollboxSize() && "absolute" === r.position, a = (o || n) && "border-box" === A.css(e, "boxSizing", !1, r), s = n ? lt(e, c, n, a, r) : 0;
                return a && o && (s -= Math.ceil(e["offset" + c[0].toUpperCase() + c.slice(1)] - parseFloat(r[c]) - lt(e, c, "border", !1, r) - .5)),
                s && (i = te.exec(t)) && "px" !== (i[3] || "px") && (e.style[c] = t,
                t = A.css(e, c)),
                ct(0, t, s)
            }
        }
    }),
    A.cssHooks.marginLeft = Ge(b.reliableMarginLeft, function(e, t) {
        if (t)
            return (parseFloat(Qe(e, "marginLeft")) || e.getBoundingClientRect().left - Pe(e, {
                marginLeft: 0
            }, function() {
    ...
    A.each({
        ...
        "margin" !== r && (A.cssHooks[r + o].set = ct)
    }),
    A.fn.extend({
        css: function(e, t) {
    ...
    ,
    nt = w.createElement("input"),
    it = w.createElement("select").appendChild(w.createElement("option")),
    nt.type = "checkbox",
    b.checkOn = "" !== nt.value,
    b.optSelected = it.selected,
    (nt = w.createElement("input")).value = "t",
    nt.type = "radio",
    b.radioValue = "t" === nt.value;
    var dt, ft = A.expr.attrHandle;
    A.fn.extend({
        attr: function(e, t) {
    ...
    A.extend({
        attr: function(e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o)
                return void 0 === e.getAttribute ? A.prop(e, t, n) : (1 === o && A.isXMLDoc(e) || (r = A.attrHooks[t.toLowerCase()] || (A.expr.match.bool.test(t) ? dt : void 0)),
                void 0 !== n ? null === n ? void A.removeAttr(e, t) : r && "set"in r && void 0 !== (i = r.set(e, n, t)) ? i : (e.setAttribute(t, n + ""),
                n) : !(r && "get"in r && null !== (i = r.get(e, t))) && null == (i = A.find.attr(e, t)) ? void 0 : i)
        },
        attrHooks: {
            type: {
                set: function(e, t) {
    ...
    A.fn.extend({
        ...
        toggleClass: function(r, t) {
            ...
            return "boolean" == typeof t && a ? t ? this.addClass(r) : this.removeClass(r) : x(r) ? this.each(function(e) {
                A(this).toggleClass(r.call(this, e, mt(this), t), t)
            }) : this.each(function() {
                var e, t, n, i;
                if (a)
                    for (t = 0,
                    ...
                    void 0 !== r && "boolean" != o || ((e = mt(this)) && V.set(this, "__className__", e),
    ...
    A.fn.extend({
        val: function(n) {
            ...
            })) : t ? (i = A.valHooks[t.type] || A.valHooks[t.nodeName.toLowerCase()]) && "get"in i && void 0 !== (e = i.get(t, "value")) ? e : "string" == typeof (e = t.value) ? e.replace(gt, "") : null == e ? "" : e : void 0
        }
    }),
    A.extend({
        valHooks: {
            ...
            select: {
                ...
                set: function(e, t) {
                    for (var n, i, r = e.options, o = A.makeArray(t), a = r.length; a--; )
                        ((i = r[a]).selected = -1 < A.inArray(A.valHooks.option.get(i), o)) && (n = !0);
    ...
    A.extend(A.event, {
        trigger: function(e, t, n, i) {
            var r, o, a, s, c, l, u, d, f = [n || w], p = g.call(e, "type") ? e.type : e, h = g.call(e, "namespace") ? e.namespace.split(".") : [];
            if (o = d = a = n = n || w,
            3 !== n.nodeType && 8 !== n.nodeType && !xt.test(p + A.event.triggered) && (-1 < p.indexOf(".") && (p = (h = p.split(".")).shift(),
            h.sort()),
            c = p.indexOf(":") < 0 && "on" + p,
            (e = e[A.expando] ? e : new A.Event(p,"object" == typeof e && e)).isTrigger = i ? 2 : 3,
            e.namespace = h.join("."),
            ...
            i || !u.trigger || !1 !== u.trigger.apply(n, t))) {
                if (!i && !u.noBubble && !m(n)) {
                    ...
                    xt.test(s + p) || (o = o.parentNode); o; o = o.parentNode)
                        f.push(o),
                        a = o;
                    a === (n.ownerDocument || w) && f.push(a.defaultView || a.parentWindow || v)
                }
                for (r = 0; (o = f[r++]) && !e.isPropagationStopped(); )
                    d = o,
                    e.type = 1 < r ? s : u.bindType || p,
                    (l = (V.get(o, "events") || Object.create(null))[e.type] && V.get(o, "handle")) && l.apply(o, t),
                    (l = c && o[c]) && l.apply && J(o) && (e.result = l.apply(o, t),
                    !1 === e.result && e.preventDefault());
                return e.type = p,
                i || e.isDefaultPrevented() || u._default && !1 !== u._default.apply(f.pop(), t) || !J(n) || c && x(n[p]) && !m(n) && ((a = n[c]) && (n[c] = null),
                A.event.triggered = p,
    ...
    function Ct(n, e, i, r) {
        ...
        if (Array.isArray(e))
            A.each(e, function(e, t) {
                i || kt.test(n) ? r(n, t) : Ct(n + "[" + ("object" == typeof t && null != t ? e : "") + "]", t, i, r)
            });
    ...
    A.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !A(this).is(":disabled") && Tt.test(this.nodeName) && !At.test(e) && (this.checked || !de.test(e))
            }).map(function(e, t) {
                var n = A(this).val();
    ...
    ,
    b.createHTMLDocument = ((wt = w.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>",
    2 === wt.childNodes.length),
    A.parseHTML = function(e, t, n) {
        return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t,
        t = !1),
        t || (b.createHTMLDocument ? ((i = (t = w.implementation.createHTMLDocument("")).createElement("base")).href = w.location.href,
        t.head.appendChild(i)) : t = w),
        o = !n && [],
        (r = S.exec(e)) ? [t.createElement(r[1])] : (r = ge([e], t, o),
    ...
    A.offset = {
        setOffset: function(e, t, n) {
            var i, r, o, a, s, c, l = A.css(e, "position"), u = A(e), d = {};
        ...
        position: function() {
            if (this[0]) {
                ...
                if ("fixed" === A.css(i, "position"))
                    ...
                    for (t = this.offset(),
                    n = i.ownerDocument,
                    e = i.offsetParent || n.documentElement; e && (e === n.body || e === n.documentElement) && "static" === A.css(e, "position"); )
                        e = e.parentNode;
    ...
    A.each(["top", "left"], function(e, n) {
        A.cssHooks[n] = Ge(b.pixelPosition, function(e, t) {
            if (t)
                return t = Qe(e, n),
                Ue.test(t) ? A(e).position()[n] + "px" : t
        })
    }),
    A.each({
        Height: "height",
    ...
    return A.noConflict = function(e) {
        return v.$ === A && (v.$ = Nt),
        e && v.jQuery === A && (v.jQuery = St),
        A
    }
    ,
    void 0 === e && (v.jQuery = v.$ = A),
    A
});
var pJS = function(e, t) {
    ...
    p.fn.retinaInit = function() {
        p.retina_detect && 1 < window.devicePixelRatio ? (p.canvas.pxratio = window.devicePixelRatio,
        p.tmp.retina = !0) : (p.canvas.pxratio = 1,
        p.tmp.retina = !1),
    ...
    p.fn.canvasSize = function() {
        ...
        p && p.interactivity.events.resize && window.addEventListener("resize", function() {
            p.canvas.w = p.canvas.el.offsetWidth,
            p.canvas.h = p.canvas.el.offsetHeight,
            p.tmp.retina && (p.canvas.w *= p.canvas.pxratio,
            p.canvas.h *= p.canvas.pxratio),
            p.canvas.el.width = p.canvas.w,
            p.canvas.el.height = p.canvas.h,
            p.particles.move.enable || (p.fn.particlesEmpty(),
    ...
    ,
    p.fn.particle = function(e, t, n) {
        if (this.radius = (p.particles.size.random ? Math.random() : 1) * p.particles.size.value,
        p.particles.size.anim.enable && (this.size_status = !1,
        this.vs = p.particles.size.anim.speed / 100,
        p.particles.size.anim.sync || (this.vs = this.vs * Math.random())),
        this.x = n ? n.x : Math.random() * p.canvas.w,
        this.y = n ? n.y : Math.random() * p.canvas.h,
        ...
        p.particles.move.bounce && p.fn.vendors.checkOverlap(this, n),
        this.color = {},
        "object" == typeof e.value)
            if (e.value instanceof Array) {
                var i = e.value[Math.floor(Math.random() * p.particles.color.value.length)];
        ...
        p.particles.opacity.anim.enable && (this.opacity_status = !1,
        ...
        p.particles.move.straight ? (this.vx = r.x,
        this.vy = r.y,
        p.particles.move.random && (this.vx = this.vx * Math.random(),
        this.vy = this.vy * Math.random())) : (this.vx = r.x + Math.random() - .5,
        ...
        if ("object" == typeof o) {
            ...
            this.shape = o;
        if ("image" == this.shape) {
            var s = p.particles.shape;
            this.img = {
                src: s.image.src,
                ratio: s.image.width / s.image.height
            },
            this.img.ratio || (this.img.ratio = 1),
            "svg" == p.tmp.img_type && null != p.tmp.source_svg && (p.fn.vendors.createSvgImg(this),
    ...
    p.fn.particle.prototype.draw = function() {
        ...
        if (null != e.opacity_bubble)
            ...
            n = e.opacity;
        if (e.color.rgb)
            var i = "rgba(" + e.color.rgb.r + "," + e.color.rgb.g + "," + e.color.rgb.b + "," + n + ")";
        else
            i = "hsla(" + e.color.hsl.h + "," + e.color.hsl.s + "%," + e.color.hsl.l + "%," + n + ")";
        switch (p.canvas.ctx.fillStyle = i,
        ...
        0 < p.particles.shape.stroke.width && (p.canvas.ctx.strokeStyle = p.particles.shape.stroke.color,
    ...
    p.fn.particlesCreate = function() {
        for (var e = 0; e < p.particles.number.value; e++)
            p.particles.array.push(new p.fn.particle(p.particles.color,p.particles.opacity.value))
    }
    ,
    p.fn.particlesUpdate = function() {
        for (var e = 0; e < p.particles.array.length; e++) {
            ...
            if (p.particles.opacity.anim.enable && (1 == t.opacity_status ? (t.opacity >= p.particles.opacity.value && (t.opacity_status = !1),
            t.opacity += t.vo) : (t.opacity <= p.particles.opacity.anim.opacity_min && (t.opacity_status = !0),
            t.opacity -= t.vo),
            t.opacity < 0 && (t.opacity = 0)),
            p.particles.size.anim.enable && (1 == t.size_status ? (t.radius >= p.particles.size.value && (t.size_status = !1),
            t.radius += t.vs) : (t.radius <= p.particles.size.anim.size_min && (t.size_status = !0),
            t.radius -= t.vs),
            ...
            switch (t.x - t.radius > p.canvas.w ? (t.x = i.x_left,
            t.y = Math.random() * p.canvas.h) : t.x + t.radius < 0 && (t.x = i.x_right,
            t.y = Math.random() * p.canvas.h),
            t.y - t.radius > p.canvas.h ? (t.y = i.y_top,
            t.x = Math.random() * p.canvas.w) : t.y + t.radius < 0 && (t.y = i.y_bottom,
            t.x = Math.random() * p.canvas.w),
            p.particles.move.out_mode) {
            case "bounce":
                (t.x + t.radius > p.canvas.w || t.x - t.radius < 0) && (t.vx = -t.vx),
                (t.y + t.radius > p.canvas.h || t.y - t.radius < 0) && (t.vy = -t.vy)
            }
            if (isInArray("grab", p.interactivity.events.onhover.mode) && p.fn.modes.grabParticle(t),
            (isInArray("bubble", p.interactivity.events.onhover.mode) || isInArray("bubble", p.interactivity.events.onclick.mode)) && p.fn.modes.bubbleParticle(t),
            (isInArray("repulse", p.interactivity.events.onhover.mode) || isInArray("repulse", p.interactivity.events.onclick.mode)) && p.fn.modes.repulseParticle(t),
            p.particles.line_linked.enable || p.particles.move.attract.enable)
                for (var r = e + 1; r < p.particles.array.length; r++) {
                    ...
                    p.particles.line_linked.enable && p.fn.interact.linkParticles(t, o),
                    p.particles.move.attract.enable && p.fn.interact.attractParticles(t, o),
                    p.particles.move.bounce && p.fn.interact.bounceParticles(t, o)
                }
        }
    }
    ,
    ...
    p.fn.interact.linkParticles = function(e, t) {
        ...
        if (r <= p.particles.line_linked.distance) {
            ...
            if (0 < o) {
                ...
                p.canvas.ctx.strokeStyle = "rgba(" + a.r + "," + a.g + "," + a.b + "," + o + ")",
    ...
    p.fn.interact.attractParticles = function(e, t) {
        var n = e.x - t.x
          , i = e.y - t.y;
        if (Math.sqrt(n * n + i * i) <= p.particles.line_linked.distance) {
            var r = n / (1e3 * p.particles.move.attract.rotateX)
              , o = i / (1e3 * p.particles.move.attract.rotateY);
            e.vx -= r,
            e.vy -= o,
            t.vx += r,
            t.vy += o
    ...
    p.fn.modes.pushParticles = function(e, t) {
        ...
        for (var n = 0; n < e; n++)
            ...
            n == e - 1 && (p.particles.move.enable || p.fn.particlesDraw(),
            p.tmp.pushing = !1)
    }
    ,
    ...
    ,
    p.fn.modes.bubbleParticle = function(s) {
        if (p.interactivity.events.onhover.enable && isInArray("bubble", p.interactivity.events.onhover.mode)) {
            var e = s.x - p.interactivity.mouse.pos_x
              , t = s.y - p.interactivity.mouse.pos_y
              , n = 1 - (c = Math.sqrt(e * e + t * t)) / p.interactivity.modes.bubble.distance;
            function i() {
                s.opacity_bubble = s.opacity,
                s.radius_bubble = s.radius
            }
            if (c <= p.interactivity.modes.bubble.distance) {
                if (0 <= n && "mousemove" == p.interactivity.status) {
                    if (p.interactivity.modes.bubble.size != p.particles.size.value)
                        if (p.interactivity.modes.bubble.size > p.particles.size.value) {
                            0 <= (o = s.radius + p.interactivity.modes.bubble.size * n) && (s.radius_bubble = o)
                        } else {
                            var r = s.radius - p.interactivity.modes.bubble.size
                              , o = s.radius - r * n;
                            s.radius_bubble = 0 < o ? o : 0
                        }
                    var a;
                    if (p.interactivity.modes.bubble.opacity != p.particles.opacity.value)
                        if (p.interactivity.modes.bubble.opacity > p.particles.opacity.value)
                            (a = p.interactivity.modes.bubble.opacity * n) > s.opacity && a <= p.interactivity.modes.bubble.opacity && (s.opacity_bubble = a);
                        else
                            (a = s.opacity - (p.particles.opacity.value - p.interactivity.modes.bubble.opacity) * n) < s.opacity && a >= p.interactivity.modes.bubble.opacity && (s.opacity_bubble = a)
                }
            } else
                i();
            "mouseleave" == p.interactivity.status && i()
            ...
            if (p.tmp.bubble_clicking) {
                e = s.x - p.interactivity.mouse.click_pos_x,
                t = s.y - p.interactivity.mouse.click_pos_y;
                var c = Math.sqrt(e * e + t * t)
                  , l = ((new Date).getTime() - p.interactivity.mouse.click_time) / 1e3;
                l > p.interactivity.modes.bubble.duration && (p.tmp.bubble_duration_end = !0),
                l > 2 * p.interactivity.modes.bubble.duration && (p.tmp.bubble_clicking = !1,
                p.tmp.bubble_duration_end = !1)
            }
            function u(e, t, n, i, r) {
                if (e != t)
                    if (p.tmp.bubble_duration_end)
                        null != n && (a = e + (e - (i - l * (i - e) / p.interactivity.modes.bubble.duration)),
                        "size" == r && (s.radius_bubble = a),
                        "opacity" == r && (s.opacity_bubble = a));
                        ...
                        if (null != n)
                            ...
                            o = i;
                        if (o != e) {
                            var a = i - l * (i - e) / p.interactivity.modes.bubble.duration;
                            "size" == r && (s.radius_bubble = a),
                            "opacity" == r && (s.opacity_bubble = a)
                        }
                    } else
                        "size" == r && (s.radius_bubble = void 0),
                        "opacity" == r && (s.opacity_bubble = void 0)
            }
            p.tmp.bubble_clicking && (u(p.interactivity.modes.bubble.size, p.particles.size.value, s.radius_bubble, s.radius, "size"),
            u(p.interactivity.modes.bubble.opacity, p.particles.opacity.value, s.opacity_bubble, s.opacity, "opacity"))
        }
    }
    ,
    p.fn.modes.repulseParticle = function(i) {
        if (p.interactivity.events.onhover.enable && isInArray("repulse", p.interactivity.events.onhover.mode) && "mousemove" == p.interactivity.status) {
            var e = i.x - p.interactivity.mouse.pos_x
              , t = i.y - p.interactivity.mouse.pos_y
              , n = Math.sqrt(e * e + t * t)
              , r = e / n
              , o = t / n
              , a = clamp(1 / (c = p.interactivity.modes.repulse.distance) * (-1 * Math.pow(n / c, 2) + 1) * c * 100, 0, 50)
              , s = {
                x: i.x + r * a,
                y: i.y + o * a
            };
            "bounce" == p.particles.move.out_mode ? (0 < s.x - i.radius && s.x + i.radius < p.canvas.w && (i.x = s.x),
            0 < s.y - i.radius && s.y + i.radius < p.canvas.h && (i.y = s.y)) : (i.x = s.x,
            i.y = s.y)
        } else if (p.interactivity.events.onclick.enable && isInArray("repulse", p.interactivity.events.onclick.mode))
            if (p.tmp.repulse_finish || (p.tmp.repulse_count++,
            p.tmp.repulse_count == p.particles.array.length && (p.tmp.repulse_finish = !0)),
            p.tmp.repulse_clicking) {
                var c = Math.pow(p.interactivity.modes.repulse.distance / 6, 3)
                  , l = p.interactivity.mouse.click_pos_x - i.x
                  , u = p.interactivity.mouse.click_pos_y - i.y
                  , d = l * l + u * u
                  , f = -c / d * 1;
                d <= c && function() {
                    var e = Math.atan2(u, l);
                    if (i.vx = f * Math.cos(e),
                    i.vy = f * Math.sin(e),
                    "bounce" == p.particles.move.out_mode) {
                        var t = i.x + i.vx
                          , n = i.y + i.vy;
                        (t + i.radius > p.canvas.w || t - i.radius < 0) && (i.vx = -i.vx),
                        (n + i.radius > p.canvas.h || n - i.radius < 0) && (i.vy = -i.vy)
                    }
                }()
            } else
                0 == p.tmp.repulse_clicking && (i.vx = i.vx_i,
                i.vy = i.vy_i)
    }
    ,
        ...
        if (p.interactivity.events.onhover.enable && "mousemove" == p.interactivity.status) {
            ...
            if (i <= p.interactivity.modes.grab.distance) {
                ...
                if (0 < r) {
                    ...
                    p.canvas.ctx.strokeStyle = "rgba(" + o.r + "," + o.g + "," + o.b + "," + r + ")",
                    p.canvas.ctx.lineWidth = p.particles.line_linked.width,
                    p.canvas.ctx.beginPath(),
                    p.canvas.ctx.moveTo(e.x, e.y),
    ...
    p.fn.vendors.eventsListeners = function() {
        ...
        (p.interactivity.events.onhover.enable || p.interactivity.events.onclick.enable) && (p.interactivity.el.addEventListener("mousemove", function(e) {
            ...
            p.interactivity.mouse.pos_y = n,
            p.tmp.retina && (p.interactivity.mouse.pos_x *= p.canvas.pxratio,
        ...
        p.interactivity.events.onclick.enable && p.interactivity.el.addEventListener("click", function() {
            if (p.interactivity.mouse.click_pos_x = p.interactivity.mouse.pos_x,
            ...
            p.interactivity.events.onclick.enable)
                ...
                case "push":
                    p.particles.move.enable || 1 == p.interactivity.modes.push.particles_nb ? p.fn.modes.pushParticles(p.interactivity.modes.push.particles_nb, p.interactivity.mouse) : 1 < p.interactivity.modes.push.particles_nb && p.fn.modes.pushParticles(p.interactivity.modes.push.particles_nb);
                    break;
                case "remove":
    ...
    p.fn.vendors.densityAutoParticles = function() {
        if (p.particles.number.density.enable) {
            ...
            n < 0 ? p.fn.modes.pushParticles(Math.abs(n)) : p.fn.modes.removeParticles(n)
        }
    }
    ,
    p.fn.vendors.checkOverlap = function(e, t) {
        for (var n = 0; n < p.particles.array.length; n++) {
            var i = p.particles.array[n]
              , r = e.x - i.x
              , o = e.y - i.y;
            Math.sqrt(r * r + o * o) <= e.radius + i.radius && (e.x = t ? t.x : Math.random() * p.canvas.w,
    ...
    p.fn.vendors.createSvgImg = function(o) {
        var e = p.tmp.source_svg.replace(/#([0-9A-F]{3,6})/gi, function(e, t, n, i) {
            if (o.color.rgb)
                var r = "rgba(" + o.color.rgb.r + "," + o.color.rgb.g + "," + o.color.rgb.b + "," + o.opacity + ")";
            else
                r = "hsla(" + o.color.hsl.h + "," + o.color.hsl.s + "%," + o.color.hsl.l + "%," + o.opacity + ")";
            return r
        })
          , t = new Blob([e],{
    ...
    p.fn.vendors.loadImg = function(e) {
        if (p.tmp.img_error = void 0,
        "" != p.particles.shape.image.src)
            if ("svg" == e) {
                var t = new XMLHttpRequest;
                t.open("GET", p.particles.shape.image.src),
                t.onreadystatechange = function(e) {
                    4 == t.readyState && (200 == t.status ? (p.tmp.source_svg = e.currentTarget.response,
                    p.fn.vendors.checkBeforeDraw()) : (console.log("Error pJS - Image not found"),
                    p.tmp.img_error = !0))
                }
                ,
                t.send()
    ...
    p.fn.vendors.draw = function() {
        "image" == p.particles.shape.type ? "svg" == p.tmp.img_type ? p.tmp.count_svg >= p.particles.number.value ? (p.fn.particlesDraw(),
        p.particles.move.enable ? p.fn.drawAnimFrame = requestAnimFrame(p.fn.vendors.draw) : cancelRequestAnimFrame(p.fn.drawAnimFrame)) : p.tmp.img_error || (p.fn.drawAnimFrame = requestAnimFrame(p.fn.vendors.draw)) : null != p.tmp.img_obj ? (p.fn.particlesDraw(),
        p.particles.move.enable ? p.fn.drawAnimFrame = requestAnimFrame(p.fn.vendors.draw) : cancelRequestAnimFrame(p.fn.drawAnimFrame)) : p.tmp.img_error || (p.fn.drawAnimFrame = requestAnimFrame(p.fn.vendors.draw)) : (p.fn.particlesDraw(),
        p.particles.move.enable ? p.fn.drawAnimFrame = requestAnimFrame(p.fn.vendors.draw) : cancelRequestAnimFrame(p.fn.drawAnimFrame))
    }
    ,
    p.fn.vendors.checkBeforeDraw = function() {
        "image" == p.particles.shape.type ? "svg" == p.tmp.img_type && null == p.tmp.source_svg ? p.tmp.checkAnimFrame = requestAnimFrame(check) : (cancelRequestAnimFrame(p.tmp.checkAnimFrame),
        p.tmp.img_error || (p.fn.vendors.init(),
        p.fn.vendors.draw())) : (p.fn.vendors.init(),
        p.fn.vendors.draw())
    }
    ,
    p.fn.vendors.init = function() {
        ...
        p.fn.particlesCreate(),
        p.fn.vendors.densityAutoParticles(),
        p.particles.line_linked.color_rgb_line = hexToRgb(p.particles.line_linked.color)
    }
    ,
    p.fn.vendors.start = function() {
        isInArray("image", p.particles.shape.type) ? (p.tmp.img_type = p.particles.shape.image.src.substr(p.particles.shape.image.src.length - 3),
        p.fn.vendors.loadImg(p.tmp.img_type)) : p.fn.vendors.checkBeforeDraw()
    }
    ,
...
window.particlesJS = function(e, t) {
    ...
    o.style.width = "100%",
    o.style.height = "100%",
    null != document.getElementById(e).appendChild(o) && pJSDom.push(new pJS(e,t))
}
,
